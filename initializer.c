...
void init_particles() {
    ...
    int lookUpTablesSize = (int) (16.00 / global.dt);
    global.r2_values = (double *) calloc(lookUpTablesSize, sizeof(double));
    global.f_over_r_values = (double *) calloc(lookUpTablesSize, sizeof(double));
